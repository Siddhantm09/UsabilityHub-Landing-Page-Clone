          ...
          <div className="right-part flex">
            ...
            <div className="right-part-below flex">
              ...
              <h4 className="company-text1">
                The navigation test is gods gift to UI designers, it probably
        ...
        <div className="big-feature flex">
          ...
          <div className="right-part flex">
            <div className="right-part-above flex">
              ...
              <p>
                Ensure you’re delivering the right features to the right
                customers by validating product concepts with your target
                audience.
              </p>
            </div>
            <div className="right-part-below flex">
